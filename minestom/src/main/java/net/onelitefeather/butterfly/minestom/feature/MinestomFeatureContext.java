...
public final class MinestomFeatureContext extends FeatureContext {
    ...
    private static FeatureManager findFeatureManagerInClassLoader(ClassLoader classLoader) {
        ...
        Iterator<FeatureManagerProvider> providerIterator = ServiceLoader.load(FeatureManagerProvider.class, classLoader).iterator();
